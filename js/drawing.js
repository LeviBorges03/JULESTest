...
import { gameState, jogador, personagem, estrelas } from './state.js';
import { hexParaRgb } from './utils.js';
import { EFEITOS } from './effects.js';
import { criarParticula, desenharParticulas } from './particles.js';
...
function aplicarEfeitos(ctx, cx, cy) {
    ...
    personagem.efeitos.forEach(efeitoKey => {
        const efeitoAtual = EFEITOS[efeitoKey];
