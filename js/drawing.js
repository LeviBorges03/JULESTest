...
function desenharMapa() {
    gameState.mapa.forEach(e => {
        if (e.tipo === "bloco" || e.tipo === "plataforma-desaparece") {
            ...
            if (e.tipo === "plataforma-desaparece" && e.timer > 0) {
                const initialTime = Math.max(10, 60 - (gameState.nivelAtual * 3));
                ctx.globalAlpha = e.timer / initialTime;
            }
